...
<tr class="encab">
<td>
<a href="#" onclick="navegaMesPeq(\''.$mes_actual.'\',\''.$anyo_actual.'\',\'menos\')" title="'.$id_anterior.'"><img src="imgs/anterior_peq.png" alt="'.$id_anterior.'" /></a>
';
$nombre_mes = numero_mes_a_nombre($mes_actual);
echo $nombre_mes;
echo '
<a href="#" onclick="navegaMesPeq(\''.$mes_actual.'\',\''.$anyo_actual.'\',\'mas\')" title="'.$id_siguiente.'"><img src="imgs/siguiente_peq.png" alt="'.$id_anterior.'" /></a>
</td>
<td>
<a href="#" onclick="navegaAnyoPeq(\''.$anyo_actual.'\',\''.$mes_actual.'\',\'menos\')" title="'.$id_anterior.'"><img src="imgs/anterior_peq.png" alt="'.$id_anterior.'" /></a>
';
echo $anyo_actual;
echo '
<a href="#" onclick="navegaAnyoPeq(\''.$anyo_actual.'\',\''.$mes_actual.'\',\'mas\')" title="'.$id_siguiente.'"><img src="imgs/siguiente_peq.png" alt="'.$id_anterior.'" /></a>
</td>
</tr>
</table>
<br />
...
$array_dias = array($id_l,$id_m,$id_x,$id_j,$id_v,$id_s,$id_d);
	...
	for($p=$posicion;$p<7;$p++)
		...
		echo '<a href="#" onclick="calendarioPeq(\''.($d+1).'\',\''.$mes_actual.'\',\''.$anyo_actual.'\')">';
		echo ($d+1);
		echo '</a>';
		echo '</td>';
		}
...
echo '<tr>';
	for($s=($d+2);$s<($d+9);$s++)
		...
		echo '<a href="#" onclick="calendarioPeq(\''.$s.'\',\''.$mes_actual.'\',\''.$anyo_actual.'\')">';
		echo $s;
		echo '</a>';
		echo '</td>';
		}
