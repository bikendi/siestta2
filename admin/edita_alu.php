...
{
conecta();
//recojo nombre campo a actualizar y código de alumno
$campo = $_POST['p1'];
$codigo = $_POST['p2'];
$valor = $_POST['p3'];
if($campo == 'f_nac')
	...
	$valor = cambia_fecha_a_ing($valor);
	}
//actualizamos
$actualiza = mysql_query("update alumnado set ".$campo." = '$valor' where codigo = '$codigo'");
}//fin hay sesión
